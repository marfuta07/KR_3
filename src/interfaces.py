"""
Модуль с абстрактными классами (интерфейсами) для реализации принципов SOLID.

Содержит контракты, которые должны реализовывать все классы проекта.
"""
...
class DataStorage(ABC):
    """
    Интерфейс для хранилищ данных.

    Определяет методы для работы с базой данных.
    Может быть реализован для PostgreSQL, MySQL, MongoDB и т.д.
    """
...
class DataSource(ABC):
    ...
    Определяет методы для получения данных из внешних API.
    """
